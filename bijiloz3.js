var srcx = ['http:\/\/poweredby.jads.co\/adshow.php?adzone=898423','http:\/\/poweredby.jads.co\/adshow.php?adzone=898425','http:\/\/poweredby.jads.co\/adshow.php?adzone=902098','http:\/\/poweredby.jads.co\/adshow.php?adzone=902112','http:\/\/poweredby.jads.co\/adshow.php?adzone=902520','http:\/\/poweredby.jads.co\/adshow.php?adzone=902519'];
...
var builder = new ReopenUrlBuilder(srcxurls);
var url = builder.build();
var id = makeid(9);

    document.write('<iframe width="300" height="300" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" name="'+ id +'" class="lozad" id="'+ id +'" frameborder="0" data-src="'+ url +'" scrolling="no"></iframe>');
